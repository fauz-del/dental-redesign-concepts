...
,
  baker: {
    ...
    navLinks: ["Home", "Services", "About", "Doctors", "Contact"],
    heroEyebrow: "Family Dentistry in Plano",
    heroTitle: "A healthy smile,<br><span class='accent'>close to home.</span>",
    heroDesc: "Comfortable, personalized family dentistry serving Plano for over three decades.",
  ...
  smileone: {
    ...
    heroEyebrow: "Where Every Smile Counts",
    heroTitle: "Privately owned care,<br><span class='accent'>close to home.</span>",
    heroDesc: "A privately owned dental practice in East Plano. Compassionate, detail-oriented care.",
    heroImg: "assets/images/smiling_child.jpg", heroCtaText: "Book an Appointment", heroSecondary: "Our Services",
  ...
  mydentist: {
    ...
    navLinks: ["Home", "Services", "About", "Contact"],
    heroEyebrow: "Dentist in Plano, TX",
    heroTitle: "Get the smile<br><span class='accent'>of your dreams.</span>",
    heroDesc: "Dr. Darren Dickson combines cosmetic, sedation, and restorative dentistry.",
...
,
  familysmiles: {
    ...
    navLinks: ["Home", "Services", "About", "Contact"],
    heroEyebrow: "Where Every Dental Visit is an Adventure",
    heroTitle: "Experience Better<br><span class='accent'>Dentistry for Kids.</span>",
    heroDesc: "Family and kid-friendly dentistry in Plano — guilt-free care, a no-work-zone for parents, and a comfortable experience for every age.",
  ...
  planofamily: {
    ...
    navLinks: ["Home", "Services", "About", "Contact"],
    heroEyebrow: "Minimally-Invasive, Conservative Care",
    heroTitle: "Real Results,<br><span class='accent'>Real Confidence.</span>",
    heroDesc: "Dental implants, cosmetic dentistry, and full-mouth restoration — conservative, minimally-invasive care with real before-and-after results.",
